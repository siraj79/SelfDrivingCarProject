...
def conv(inputs, filters, kernel_size=1, strides=1, pad='same', k_init_std=1e-2, k_reg_scale=1e-3, name=None):
    """
    ...
    """
    return tf.layers.conv2d(inputs, filters, kernel_size, strides, padding=pad,
