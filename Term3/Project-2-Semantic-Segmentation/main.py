...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # TODO: Implement function
    l7_1x1 = helper.conv(inputs=vgg_layer7_out, filters=num_classes, kernel_size=1, strides=1)
    l4_1x1 = helper.conv(inputs=vgg_layer4_out, filters=num_classes, kernel_size=1, strides=1)
    l3_1x1 = helper.conv(inputs=vgg_layer3_out, filters=num_classes, kernel_size=1, strides=1)
    ...
    return helper.convTranspose(inputs=output, filters=num_classes, kernel_size=16, strides=8)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        # 2 ) Build Fully Convolutional Network
        ...
        helper.saveVideo(sess, image_shape, logits, keep_prob, image_input)
